...
* If we pass primitive value as a parameter then it is call by value
* If we pass Non primitive value as a parameter then it is call by reference(because reference of that object is pass as a parameter)

<br/>

## **First class function**
Function always act as a First class function i.e
* Can return function
* Pass as a parameter
